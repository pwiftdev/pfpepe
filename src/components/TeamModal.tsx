    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div className="relative w-full max-w-3xl bg-gradient-to-br from-[#0a0e17] via-[#15202b] to-[#0a0e17] rounded-2xl border-2 border-[#00ff41] shadow-[0_0_50px_rgba(0,255,65,0.3)] overflow-hidden">
              {/* Close Button */}
              <button
                onClick={onClose}
                  ...
                  {teamMembers.map((member, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {isHighlighted && (
                          <div className="absolute -top-3 left-1/2 transform -translate-x-1/2 z-10 flex items-center gap-1 px-3 py-1 bg-gradient-to-r from-yellow-400 to-yellow-600 rounded-full shadow-lg">
                            <FaStar className="w-3 h-3 text-white animate-pulse" />
                            <span className="text-xs font-bold text-white">LEAD</span>
                            <FaStar className="w-3 h-3 text-white animate-pulse" />
                          </div>
                        )}
                        
                        <div 
                          className={`bg-black/40 border-2 rounded-xl p-6 transition-all duration-300 h-full flex flex-col ${
                            isHighlighted 
                              ? 'border-yellow-500 shadow-[0_0_30px_rgba(255,215,0,0.4)] hover:shadow-[0_0_40px_rgba(255,215,0,0.6)] scale-105' 
                        ...
                        >
                          ...
                          <div className="flex justify-center mb-4">
                            <div 
                              className={`relative w-24 h-24 rounded-full overflow-hidden transition-all duration-300 group-hover:scale-110 ${
                                isHighlighted ? 'ring-4 ring-yellow-500 shadow-[0_0_20px_rgba(255,215,0,0.5)]' : 'ring-2 ring-gray-600'
                              }`}
                            >
                              <Image 
                                src="/pepeimage.png" 
                          ...
                          <a
                            ...
                            className={`flex items-center justify-center gap-2 px-4 py-2 rounded-lg transition-all duration-300 hover:scale-105 font-semibold ${
                              isHighlighted 
